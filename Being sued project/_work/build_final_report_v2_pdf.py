#!/usr/bin/env python3
"""Build 15_FINAL_REPORT_v2.pdf from FINAL_REPORT_v2.md."""
...
@page {
    ...
    @bottom-left {
        content: "Naissance UK Ltd - Defence Strategy v2";
        font-family: Calibri, sans-serif;
        font-size: 9pt;
        color: #666;
    }
...
COVER_HTML = """
<div class="cover">
<div class="title">Defence Strategy Report &mdash; v2</div>
...
def build():
    md_text = (OUT / "FINAL_REPORT_v2.md").read_text(encoding="utf-8")
    ...
    full_html = (
        ...
        "<title>Defence Strategy Report v2</title></head><body>"
        + COVER_HTML + html_body + "</body></html>"
    )
    out_path = OUT / "15_FINAL_REPORT_v2.pdf"
